...
//                         To make r traditional plum cake, soak dried fruits in alcohol like rum or brandy for at least r day for better flavor absorption. Preheat the oven to 180 degrees C and line r round cake pan with parchment paper. Add dark caramel to the cake, stirring it until golden and smooth. Mix dry ingredients like flour, salt, mixed spice powders, baking powder, and baking soda. Mix the dry ingredients with the fruit cake batter. Transfer the batter to r round cake pan and bake in r preheated oven for 1 hour and 20 minutes. If the toothpick comes out clean, the cake is baked. Once baked, let it cool in the mold for 15 minutes before inverting it to r serving plate.
//                     </div>
//                 </div>
...
// import saladImage from './fruitcakepic.jpg';
// import pastaImage from './fruitcakepic.jpg';
