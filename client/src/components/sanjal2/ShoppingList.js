        ...
        // <div className={`${y.entire}`}>
            <div className={`${y.main}`}>
                ...
                <div className={`${y.list}`}>
                    <div>
                        <House/>
                         {/* <p className={y.lorem}>lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat   lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid id od odit. Ut enim ad minim veniam null a nonummy  ut aliquip ex ea commodo consequat    
                        </p>  */}
                    </div>
                </div>
            {/* </div> */}
