...
const CheeseCake= () => {
  ...
  const [customIngredient, setCustomIngredient] = useState(''); // State for custom ingredient
  ...
  const handleInputChange = (event) => {
    setCustomIngredient(event.target.value); // Update custom ingredient state
  };

  const handleAddIngredient = () => {
    // Add custom ingredient to the ingredients list
    // You can modify this logic as per your requirement
    // Here, I'm just logging the custom ingredient to console
    console.log("Custom Ingredient:", customIngredient);
    setCustomIngredient(''); // Clear the input field
  };
    ...
    <div style={backgroundStyle}>
      ...
      <div className='non-title'>
        ...
        <div className='ingredriants-todo-list '>
          ...
          {/* <h4 className='subtitle-ing-sj'>Crust:</h4> */}
          <ul>
            <li className={ingredientsChecked.crust1 ? 'checked' : ''}>
              <input 
                type="checkbox" 
                id="crust1" 
                checked={ingredientsChecked.crust1} 
                onChange={() => handleCheckboxChange('crust1')} 
              />
              <label htmlFor="crust1">1 1/2 cups graham cracker, crushed</label>
            </li>
            <li className={ingredientsChecked.crust2 ? 'checked' : ''}>
              <input 
                type="checkbox" 
                id="crust2" 
                checked={ingredientsChecked.crust2} 
                onChange={() => handleCheckboxChange('crust2')} 
              />
              <label htmlFor="crust2">6 tablespoons butter, melted</label>
            </li>
          </ul>

          {/* <h4 className='subtitle-ing-sj'>Filling:</h4> */}
          <ul>
            <li className={ingredientsChecked.filling1 ? 'checked' : ''}>
              <input 
                type="checkbox" 
                id="filling1" 
                checked={ingredientsChecked.filling1} 
                onChange={() => handleCheckboxChange('filling1')} 
              />
              <label htmlFor="filling1">1 cup cream cheese, at room temperature</label>
            </li>
            <li className={ingredientsChecked.filling2 ? 'checked' : ''}>
              <input 
                type="checkbox" 
                id="filling2" 
                checked={ingredientsChecked.filling2} 
                onChange={() => handleCheckboxChange('filling2')} 
              />
              <label htmlFor="filling2">2/3 cup Condensed Milk</label>
            </li>
            <li className={ingredientsChecked.filling3 ? 'checked' : ''}>
              <input 
                type="checkbox" 
                id="filling3" 
                checked={ingredientsChecked.filling3} 
                onChange={() => handleCheckboxChange('filling3')} 
              />
              <label htmlFor="filling3">1 teaspoon vanilla extract</label>
            </li>
            <li className={ingredientsChecked.filling4 ? 'checked' : ''}>
              <input 
                type="checkbox" 
                id="filling4" 
                checked={ingredientsChecked.filling4} 
                onChange={() => handleCheckboxChange('filling4')} 
              />
              <label htmlFor="filling4">1/2 cup heavy cream</label>
            </li>
          </ul>

          {/* add more button */}
          <div className='add-todo-ingr'>
            <input className='enter-new-ing' type="text" placeholder="Add custom Incrediants" value={customIngredient} onChange={handleInputChange} /> 
            <button className='button-plus'> <i class="fa-solid fa-plus"></i> </button>
          </div>
        </div>
